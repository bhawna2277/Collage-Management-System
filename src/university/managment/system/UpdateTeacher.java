...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    JTextField tfcourse,tfaddress,tfphone,tfemail,tfbranchs ;
    JLabel labelEmpId;
    Choice CEmpId;
     ...
     JButton cancle;
      ...
      JLabel lblrollnumber = new JLabel("Select Emplyoee ID");
       ...
       e.printStackTrace();}
          ...
          add(labelEmpId);
           ...
           lbaadhar.setFont(new Font("serif",Font.BOLD,20));
            ...
            JLabel lblbranch= new JLabel("departpent");
            ...
            tfbranchs =new JTextField();
            tfbranchs.setBounds(600, 400, 150, 30);
            ...
            tfcourse.setText(rs.getString("education"));
             tfbranchs.setText(rs.getString("depaertpent"));
            }
            }catch(Exception e){
            e.printStackTrace();
            }
    ...
    cancle.setBounds(450,500,120,30);
    add(cancle);
  ...
  cancle.addActionListener(this);
   cancle.setFont(new Font("Tahoma",Font.BOLD, 18));
    ...
    if(ae.getSource()==submit){
        ...
        String branch= tfbranchs.getText();
